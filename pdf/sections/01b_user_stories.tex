...
US-04 & Customer & Là khách thuê xe, tôi muốn lọc loại xe và chọn xe còn trống để gửi yêu cầu thuê. & Xe available mới thuê được; xe đang giữ chỗ/đang thuê/hỏng bị loại khỏi hành động thuê. \\
...
US-06 & Station Staff & Là nhân sự bãi, tôi muốn xem request chờ nhận xe để kiểm tra khách và bàn giao đúng xe. & Màn hình hiển thị khách, xe, bãi, CCCD và thời lượng; handover yêu cầu cọc 200k. \\
...
US-08 & Station Staff & Là nhân sự bãi, tôi muốn nhận xe trả tại bãi được phân công, cập nhật tình trạng và xuất vé. & Rental completed, ticket có phí cơ bản, giảm giá, phụ thu và tổng tiền; xe đổi trạng thái tại bãi trả hợp lệ. \\
...
US-11 & Presenter & Là người demo, tôi muốn mở riêng một tab điều khiển để kéo GPS xe và tua giờ hệ thống trong lúc user/admin diễn flow. & Route \texttt{/gd} chạy độc lập, marker snap theo đường, có đồng hồ nội bộ để demo phụ thu trễ và không làm mất session user/admin. \\
\bottomrule
\end{longtable}
