...
đầu trang khi chuyển màn hình làm việc. Thanh trên dùng nền đặc hơn khi sticky
để nội dung cuộn phía dưới không bị chồng mờ lên nút tài khoản, làm mới và đăng
xuất. Giao diện cũng hỗ trợ ba chế độ \textit{Sáng}, \textit{Tối} và
\textit{Hệ thống}; theme được lưu ở trình duyệt, triển khai bằng design tokens
cho panel, bảng, dropdown và chart, trong khi bản đồ Leaflet và scene Three.js
vẫn giữ độ sáng riêng để không làm mất khả năng quan sát khi demo. Trên mobile,
...
\begin{minipage}{0.31\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.58\textheight,keepaspectratio,trim=0 2030bp 0 0,clip]{customer_mobile.png}\\
{\scriptsize Tổng quan}
\end{minipage}\hfill
\begin{minipage}{0.31\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.58\textheight,keepaspectratio,trim=0 1120bp 0 900bp,clip]{customer_mobile.png}\\
{\scriptsize Tìm bãi}
\end{minipage}\hfill
\begin{minipage}{0.31\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.58\textheight,keepaspectratio,trim=0 600bp 0 1450bp,clip]{customer_mobile.png}\\
{\scriptsize Chọn xe}
\end{minipage}
...
\centering
\includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio,trim=0 2450bp 0 0,clip]{operations_desktop.png}\\[2mm]
\raggedright{\small Tổng quan vận hành, thống kê và biểu đồ báo cáo}
\end{minipage}\\[4mm]
\begin{minipage}{0.96\textwidth}
\centering
\includegraphics[width=\linewidth,height=0.38\textheight,keepaspectratio,trim=0 1300bp 0 1020bp,clip]{operations_desktop.png}\\[2mm]
\raggedright{\small Yêu cầu nhận xe, pipeline trả xe và danh sách đội xe}
\end{minipage}
...
\node[aid] (gps) at (5.75,-1.30) {GPS xe\\theo đường};
...
danh sách bãi/xe sẵn sàng, giao diện hiển thị skeleton loading để không xuất hiện
