...
đã được chọn. Trong phạm vi UC002, GPS / Map Service tham gia UC002.1 để cung cấp
vị trí/khu vực tìm kiếm và tọa độ dùng cho geofence bãi nhận.
...
\begin{enumerate}
  ...
  \item Hệ thống kiểm tra lại trạng thái xe, bãi xe, điều kiện tài khoản và tọa độ Customer trong bán kính bãi.
...
\begin{enumerate}
  ...
  \item Hệ thống kiểm tra lần cuối trạng thái xe, bãi xe và tọa độ Customer đã xác nhận trong bán kính bãi nhận.
...
\begin{itemize}
  ...
  \item Customer có thể xác nhận vị trí hiện tại trong bán kính bãi trả.
...
\begin{enumerate}
  ...
  \item Customer xác nhận bãi trả bằng GPS/vị trí hiện tại trên tài khoản.
  \item Staff tra cứu Rental bằng mã thuê, Customer hoặc mã xe.
  \item Hệ thống hiển thị thông tin lượt thuê, bãi nhận, bãi trả đã xác nhận, xe, thời điểm bắt đầu, thời lượng dự kiến và tiền đặt cọc (xem Table A4).
  \item Staff kiểm tra tình trạng xe khi nhận lại.
  \item Staff xác nhận thời điểm trả xe và ghi chú kiểm tra.
  \item Hệ thống kiểm tra xác nhận trả còn nằm trong bán kính bãi trả, cập nhật return station và tính thời lượng thực tế.
...
7 & Step 7 & Staff chọn bãi trả khác bãi Customer đã xác nhận. & Hệ thống chặn xuất vé và yêu cầu dùng đúng bãi xác nhận hoặc yêu cầu Customer xác nhận lại. & Step 2 \\
8 & Step 8 & Thời lượng thực tế nhỏ hơn mốc thuê đã chọn. & Hệ thống vẫn tính theo mốc giá/chính sách đã xác nhận khi thuê nếu chính sách quy định vậy. & Step 9 \\
...
10 & Step 10 & Trả muộn không tròn 30 phút. & Hệ thống làm tròn phụ thu theo chính sách 30 phút phát sinh. & Step 11 \\
11 & Step 10 & Customer tranh chấp thời gian trả muộn. & Hệ thống vẫn lưu vé theo dữ liệu hiện tại và tạo cờ cần Admin / Operator rà soát. & Step 11 \\
