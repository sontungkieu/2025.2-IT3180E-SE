...
theo cookie, giữ chỗ xe bằng request pending có geofence bãi nhận, giao xe có
cọc/giấy tờ và kiểm tra lại vị trí khách, đổi xe trước handover, trả xe khác bãi
sau khi customer xác nhận vị trí trong bán kính bãi trả, tính vé, giảm giá cư dân,
cập nhật trạng thái xe, mở nhật ký audit và tổng hợp báo cáo có biểu đồ/table/CSV.
...
\draw[msg] (0,-4.0) -- node[above,font=\tiny] {5. confirmed return station/time/condition} (4.2,-4.0);
