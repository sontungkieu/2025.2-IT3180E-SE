...
\begin{column}{0.49\textwidth}
\centering
\slidecaption{Yêu cầu nhận xe và pipeline trả xe}
\end{column}
\end{columns}
\vspace{0.15cm}
\scriptsize Screenshot operations được chụp riêng theo từng trạng thái để phần tổng quan và khu vực xử lý luôn rõ khi thuyết trình.
\end{frame}
